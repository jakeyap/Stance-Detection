...
if __name__ == '__main__':
    ...
    state_dict_paths = {
        ...
        'aen_bert': 'state_dict/aen_bert_twitter_val_acc0.7298'
    }
    ...
    text_bert_indices, bert_segments_ids, text_raw_bert_indices, aspect_bert_indices = \
        prepare_data('she wiped clean + 30k deleted emails , explains', ' dereliction of duty/lies', '', tokenizer)
    
    #The greatest tragedy in life is the prayers that go unanswered because they go unasked.
    #we could all just not use religion and beliefs as an excuse to murder and hate?
    #We become what we worship. So be intentional in choosing what you worship for that is what you will become. 
    #she wiped clean + 30k deleted emails, explains dereliction of duty/lies
